...
$sql = mysqli_query($conn,"SELECT firstname,lastname,usersEmail FROM users where usersUid = '$suid';");
...
if(isset($_POST['submit2']))
{
	...
	$last2=$_POST['lname'];
	$email2=$_POST['uemail'];
	$sql2 = mysqli_query($conn,"UPDATE users SET firstname='$first2',lastname='$last2',usersEmail='$email2' where usersUid = '$suid2';");
		?>
